...
<?php
    ...
    if(isset($_POST["submit"])){
     ...
     $username=$_SESSION["username"];
      ...
      $login=mysqli_query($koneksi,"select * from produk where
...
<div class="wrapper">
        ...
        <form class="p-3 mt-3">
            <div class="form-field d-flex align-items-center">
                ...
                <input type="text" name="id_produk" id="id_produk" placeholder="Id Produk">
            </div>
            <div class="form-field d-flex align-items-center">
            ...
            <button type="submit" name="submit" value="submit" class="btn mt-3">Login</button>
